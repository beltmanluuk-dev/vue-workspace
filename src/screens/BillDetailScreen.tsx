...
import { formatCurrency, formatDate, getDaysUntilDue, formatFullDate } from '../utils/helpers';
...
export const BillDetailScreen: React.FC<BillDetailScreenProps> = ({ route, navigation }) => {
  ...
  const billId = route?.params?.billId || store.selectedBillId || store.bills[0]?.id;
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.empty}>
          <Text style={styles.emptyTitle}>Faktura hittades inte</Text>
        </View>
      </SafeAreaView>
    );
  }
