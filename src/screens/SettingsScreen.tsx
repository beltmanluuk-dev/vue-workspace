  ...
  return (
    <SafeAreaView style={[styles.container, styles.container]}>
      ...
      >
        ...
        <TouchableOpacity
          style={[styles.profileCard, styles.profileCard]}
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.sectionCard, styles.sectionCard]}>
            ...
            <SettingRow
              ...
              subtitle="Påminnelser & varningar"
            ...
            <SettingRow
              icon={<CreditCard size={20} color={colors.textSecondary} />}
              label="Budgetar"
              subtitle="Sätt gränser per kategori"
              onPress={() => handleSettingPress('budgets')}
            />
            <View style={[styles.divider, styles.divider]} />
            <SettingRow
              icon={<User size={20} color={colors.textSecondary} />}
              label="Family Connect"
              subtitle="Dela ekonomin med familjen"
              onPress={() => handleSettingPress('family')}
            />
          </View>
        </View>
